...
export type GeneralTreatmentItem = {
  id: string;
  title: string;
  image: string;
  imageAlt: string;
...
export const GENERAL_TREATMENTS: GeneralTreatmentItem[] = [
  {
    id: 'athletic-mouthguards',
    title: 'Athletic Mouthguards',
    image: '/assets/services/general-dentistry/mouth-guards.jpg',
    imageAlt: 'Custom athletic mouthguards for sports protection in Austin',
  ...
  },
  {
    ...
    imageAlt: 'Custom nightguards for teeth grinding relief in Austin',
  ...
  },
  {
    ...
    imageAlt: 'Preventive fluoride varnish application in Austin',
  ...
  },
  {
    ...
    imageAlt: 'Protective dental sealant application on molars in Austin',
  ...
  },
  {
    ...
    imageAlt: 'Routine oral cancer screening examination in Austin',
  ...
  },
  {
    ...
    imageAlt: 'Advanced laser periodontal treatment in Austin',
  ...
  },
  {
    ...
    imageAlt: 'Dentist reviewing TMJ therapy options in Austin',
  ...
  },
  {
    ...
    imageAlt: 'Halitosis diagnosis and breath care treatment in Austin',
        ...
        <div className="container-clinical space-y-8">
          <div className="text-center space-y-2 max-w-2xl mx-auto">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-heading font-bold text-foreground tracking-tight">
              Our Preventive & General Dental Services
            </h2>
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
              Explore our full range of gentle general dental services designed to keep your natural teeth strong, functional, and healthy.
            </p>
          </div>

          {/* Cards Grid */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
            {GENERAL_TREATMENTS.map((treatment) => (
              <div
                key={treatment.id}
                id={treatment.id}
                className="group relative overflow-hidden rounded-2xl border border-primary/15 bg-white p-2.5 sm:p-3 shadow-sm hover:shadow-lg hover:border-primary/30 transition-all duration-300 flex flex-col justify-between"
              >
                <div className="space-y-3">
                  ...
                  <div className="px-1.5 pt-0.5 space-y-1.5">
                    <h3 className="text-base sm:text-lg font-heading font-bold text-foreground group-hover:text-primary transition-colors tracking-tight leading-tight">
                      {treatment.title}
                    </h3>
                    <p className="text-sm sm:text-base text-foreground/85 font-normal leading-relaxed line-clamp-2">
                      {treatment.summary}
                    </p>
                  </div>
                </div>
                ...
                {/* Card Action Footer */}
                <div className="px-1.5 pt-3 mt-3 border-t border-primary/10 flex items-center justify-between gap-2">
                  <button
                    type="button"
                  ...
                  <Link href="/contact#request-appointment">
                    <Button size="sm" className="btn-primary text-xs px-3 py-1.5 h-8 font-semibold shadow-sm">
                      Book Now
                    </Button>
                  </Link>
                </div>
            ...
            <div className="relative">
              ...
              <div className="bg-gradient-to-br from-primary/10 via-clinical-creme to-white p-5 sm:p-7 border-b border-primary/10">
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-5">
                  ...
                  <div className="space-y-1.5 text-center sm:text-left flex-1">
                    ...
                    <DialogDescription className="text-sm sm:text-base text-foreground/85 font-normal leading-relaxed">
              ...
              <div className="p-5 sm:p-7 space-y-4 max-h-[50vh] overflow-y-auto">
                <div className="space-y-1.5">
                  <h4 className="text-sm sm:text-base font-bold uppercase tracking-wider text-primary">
                    Who Is This For?
                  </h4>
              ...
              <div className="bg-clinical-creme/60 p-4 sm:p-5 border-t border-primary/10 flex flex-col sm:flex-row items-center justify-between gap-3">
                <p className="text-xs sm:text-sm text-foreground/75 text-center sm:text-left">
                  Ready to discuss {selectedTreatment.title.toLowerCase()}?
                </p>
