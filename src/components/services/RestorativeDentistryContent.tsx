...
export const RESTORATIVE_TREATMENTS: TreatmentItem[] = [
  {
    id: 'cerec-crowns',
    category: 'same-day',
    ...
    imageAlt: 'CEREC same day crowns technology in Austin',
  ...
  },
  {
    ...
    imageAlt: 'Tooth colored composite dental fillings in Austin',
  ...
  },
  {
    ...
    imageAlt: 'Dental implant procedure model in Austin',
  ...
  },
  {
    ...
    image: '/assets/services/Restorative-Dentistry/cosmetic-2.jpg',
    imageAlt: 'Dental bridge illustration in Austin',
  ...
  },
  {
    ...
    image: '/assets/services/Restorative-Dentistry/cosmetic-3.jpg',
    imageAlt: 'Full and partial dentures in Austin',
  ...
  },
  {
    ...
    imageAlt: 'Root canal therapy treatment setup in Austin',
  ...
  },
  {
    ...
    image: '/assets/services/Restorative-Dentistry/teeth-whiting.jpg',
    imageAlt: 'Dental extraction instruments in Austin',
  ...
  },
  {
    ...
    image: '/assets/services/Restorative-Dentistry/Restorative-Dental-Procedures.png',
    imageAlt: 'Oral surgery and bone graft procedure model in Austin',
...
export default function RestorativeDentistryContent() {
          ...
          <DialogContent className="max-w-2xl p-0 overflow-hidden rounded-2xl bg-white border border-primary/20 shadow-2xl">
            <div className="relative">
              ...
              <div className="p-5 sm:p-7 space-y-4 max-h-[50vh] overflow-y-auto">
                ...
                {selectedTreatment.details.benefits && selectedTreatment.details.benefits.length > 0 && (
                  <div className="space-y-2 pt-1">
                    <h4 className="text-xs sm:text-sm font-bold uppercase tracking-wider text-primary">
                      Key Treatment Benefits
                    </h4>
                    <ul className="grid gap-1.5 pl-1">
                      {selectedTreatment.details.benefits.map((benefit, i) => (
                        <li key={i} className="flex items-start gap-2 text-sm sm:text-[15px] text-foreground/90">
